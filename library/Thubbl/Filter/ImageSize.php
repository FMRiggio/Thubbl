...
/**
 * @see Thubbl_Filter_ImageSize_Strategy_Fit
 */
require_once 'Thubbl/Filter/ImageSize/Strategy/Fit.php';
require_once 'Thubbl/Filter/ImageSize/Strategy/Crop.php';
require_once 'Thubbl/Filter/ImageSize/Strategy/Resize.php';
 ...
 */
class Thubbl_Filter_ImageSize implements Zend_Filter_Interface
{
    /**
    ...
    /**
     * Resizing strategy.
     * @var Thubbl_Filter_ImageSize_Strategy_Interface
     */
     ...
     * @return Thubbl_Filter_ImageSize Fluent interface
     */
     ...
     * @param Thubbl_Filter_ImageSize_Strategy_Interface $strategy
     * @return Thubbl_Filter_ImageSize Fluent interface
     */
    public function setStrategy(Thubbl_Filter_ImageSize_Strategy_Interface $strategy)
    {
     ...
     * @return Thubbl_Filter_ImageSize_Strategy_Interface
     */
    public function getStrategy()
    {
        if(is_null($this->_strategy)) {
            $this->_strategy = new Thubbl_Filter_ImageSize_Strategy_Fit();
        }
