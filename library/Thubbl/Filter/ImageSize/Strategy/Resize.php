 ...
 */
require_once 'Thubbl/Filter/ImageSize/Strategy/Interface.php';

/**
 * Strategy for resizing the image by fitting the content into the given 
 * dimensions.
 */
class Thubbl_Filter_Imagesize_Strategy_Resize 
    implements Thubbl_Filter_ImageSize_Strategy_Interface
{
    /**
